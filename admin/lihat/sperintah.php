...
$id = $_GET['id'];
    $qCek = mysqli_query($connect, "SELECT * FROM tb_sperintah WHERE id_perintah='$id'");
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal" method="post" action="../proses/pr-updatsperintah.php">

                            <?php } ?> 
                                <div class="form-body">
                                    <div class="row">
                                        <input type="hidden" name="id" value="<?php echo $row['id_perintah']; ?>" class="form-control">
