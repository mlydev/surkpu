<?php
    ...
    $qVerif = mysqli_query($connect, "SELECT * FROM tb_skeputusan WHERE id_keputusan='$id' AND otp='$otp'");
    ...
    $qUpdate = "UPDATE tb_skeputusan SET status='$status_surat' WHERE tb_skeputusan.id_keputusan='$id'";
