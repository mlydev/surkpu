<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $qTambahSurat = "INSERT INTO tb_sperintah (nomer, menimbang_1, menimbang_2, dasar_1, dasar_2, kepada_1, kepada_2, kepada_3, untuk_1, untuk_2, jabatan, nama, tanggal, otp, status, jenis)
